...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ url('/') }}" class="logo d-flex align-items-center">
                <img src="assets/img/homeFinder.png" alt="">
                <span class="d-none d-lg-block">HomeFinder360</span>
            </a>
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="components-accordion.html">
                            <i class="bi bi-circle"></i><span>Landlord</span>
                        </a>
                    </li>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>HomeFinder360</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            <!-- All the links in the footer should remain intact. -->
            <!-- You can delete the links only if you purchased the pro version. -->
            <!-- Licensing information: https://KhaliqTech.com/license/ -->
            <!-- Purchase the pro version with working PHP/AJAX contact form: https://KhaliqTech.com/nice-admin-bootstrap-admin-html-template/ -->
            Designed by <a href="https://KhaliqTech.com/">KhaliqTech</a>
        </div>
    </footer><!-- End Footer -->
