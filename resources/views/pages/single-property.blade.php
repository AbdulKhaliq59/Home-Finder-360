...
<head>
    ...
    <title>HomeFinder360 | Single </title>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('properties') }}">Property</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <div class="title-single-box">
                            ...
                            <span class="color-text-a">Nyarugenge, Kigali City KN123</span>
                        </div>
                    </div>
                                ...
                                <div class="property-price d-flex justify-content-center foo">
                                    <div class="card-header-c d-flex">
                                        <div class="card-box-ico">
                                            <span class="bi bi-cash">RWF</span>
                                        </div>
                                    ...
                                    <div class="summary-list">
                                        <ul class="list">
                                            ...
                                            <li class="d-flex justify-content-between">
                                                ...
                                                <span>Nyarugenge, Kigali City KN123</span>
                                            </li>
                                            <li class="d-flex justify-content-between">
